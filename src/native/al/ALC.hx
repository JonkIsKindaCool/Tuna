...
extern class ALC {
	...
	static function getProcAddress(device:Device, func:cpp.ConstCharStar):cpp.RawPointer<cpp.Void>;
	...
	static function captureSamples(device:Device, buffer:cpp.RawPointer<cpp.Void>, samples:Int):Void;
}
