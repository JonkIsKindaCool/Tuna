...
extern class AL {
	...
	static function getProcAddress(func:cpp.ConstCharStar):cpp.RawPointer<cpp.Void>;
	...
	@:native('alGenBuffers')
	static function genBuffers(n:Int, buffer:RawPointer<cpp.UInt32>):Void;
	...
	@:native('alBufferData')
	static function bufferData(buffer:cpp.UInt32, format:Int, data:Star<cpp.Void>, size:cpp.UInt64, sampleRate:Int):Void;
