...
import native.sdl.Types.SDLInitFlags;

@:include("vendor/include/Headers.h")
@:buildXml("<include name=\"${haxelib:tuna}/include.xml\"/>")
/**
 ...
 * 
 * Got from
 * @see https://github.com/swordcube/hxsdl 
 */
extern class SDL {
	// SDL.h //
	@:native("SDL_Init")
	...
	static inline function setHintWithPriority(name:ConstCharStar, value:ConstCharStar, priority:SDLHintPriority):Bool {
	...
	static function addHintCallback(name:ConstCharStar, callback:SDLHintCallback, userdata:RawPointer<Void>):Void;

	@:native("SDL_DelHintCallback")
	static function deleteHintCallback(name:ConstCharStar, callback:SDLHintCallback, userdata:RawPointer<Void>):Void;
	...
	static function logAllSetPriority(priority:SDLLogPriority):Void;

	@:native("SDL_LogSetPriority")
	static function logSetPriority(category:SDLLogCategory, priority:SDLLogPriority):Void;

	@:native("SDL_LogGetPriority")
	static function logGetPriority(category:SDLLogCategory):SDLLogPriority;
	...
	static function logVerbose(category:SDLLogCategory, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogDebug")
	static function logDebug(category:SDLLogCategory, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogInfo")
	static function logInfo(category:SDLLogCategory, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogWarn")
	static function logWarn(category:SDLLogCategory, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogError")
	static function logError(category:SDLLogCategory, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogCritical")
	static function logCritical(category:SDLLogCategory, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogMessage")
	static function logMessage(category:SDLLogCategory, priority:SDLLogPriority, fmt:ConstCharStar, args:Rest<Any>):Void;

	@:native("SDL_LogMessageV")
	static function logMessageV(category:SDLLogCategory, priority:SDLLogPriority, fmt:ConstCharStar, va:VarArg):Void;

	@:native("SDL_LogGetOutputFunction")
	static inline function logGetOutputFunction(userdata:Any):SDLLogOutputFunction {
	...
	static inline function logSetOutputFunction(callback:SDLLogOutputFunction, userdata:Any):Void {
	...
	static inline function getDisplayBounds(displayIndex:Int):SDLRectangle {
		var result:Int = 0;
	...
	static inline function getDisplayUsableBounds(displayIndex:Int):SDLRectangle {
		var result:Int = 0;
	...
	static function getDisplayOrientation(displayIndex:Int):SDLDisplayOrientation;

	@:native("SDL_GetNumDisplayModes")
	static function getNumDisplayModes(displayIndex:Int):Int;

	@:native("SDL_GetDisplayMode")
	static inline function getDisplayMode(displayIndex:Int, modeIndex:Int):SDLDisplayMode {
		var result:Int = 0;
	...
	static inline function getDesktopDisplayMode(displayIndex:Int):SDLDisplayMode {
		var result:Int = 0;
	...
	static inline function getCurrentDisplayMode(displayIndex:Int):SDLDisplayMode {
		var result:Int = 0;
	...
	static function getClosestDisplayMode(displayIndex:Int, mode:ConstPointer<SDLDisplayMode>, closest:RawPointer<SDLDisplayMode>):RawPointer<SDLDisplayMode>;

	@:native("SDL_GetPointDisplayIndex")
	static inline function getPointDisplayIndex(point:SDLPoint):Int {
		return untyped __cpp__("SDL_GetPointDisplayIndex(&{0})", point);
	}

	@:native("SDL_GetRectDisplayIndex")
	static inline function getRectDisplayIndex(rect:SDLRectangle):Int {
		return untyped __cpp__("SDL_GetRectDisplayIndex(&{0})", rect);
	}

	@:native("SDL_GetWindowDisplayIndex")
	static function getWindowDisplayIndex(window:SDLWindow):Int;

	@:native("SDL_SetWindowDisplayMode")
	static inline function setWindowDisplayMode(window:SDLWindow, mode:SDLDisplayMode):Int {
		return untyped __cpp__("SDL_SetWindowDisplayMode({0}, &{1})", window, mode);
	}

	@:native("SDL_GetWindowDisplayMode")
	static inline function getWindowDisplayMode(window:SDLWindow):SDLDisplayMode {
		var result:Int = 0;
	...
	static inline function getWindowICCProfile(window:SDLWindow, size:UInt64):Any {
		return untyped __cpp__("SDL_GetWindowICCProfile({0}, &{1})", window, size);
	}

	@:native("SDL_GetWindowPixelFormat")
	static function getWindowPixelFormat(window:SDLWindow):SDLPixelFormat;

	@:native("SDL_CreateWindow")
	static function createWindow(title:ConstCharStar, x:Int, y:Int, w:Int, h:Int, flags:SDLWindowInitFlags):SDLWindow;

	@:native("SDL_CreateWindowFrom")
	static inline function createWindowFrom(data:Any):SDLWindow {
		return untyped __cpp__("SDL_CreateWindowFrom((void*){0})", data);
	}

	@:native("SDL_GetWindowID")
	static function getWindowID(window:SDLWindow):UInt32;

	@:native("SDL_GetWindowFromID")
	static function getWindowFromID(id:UInt32):SDLWindow;

	@:native("SDL_GetWindowFlags")
	static function getWindowFlags(window:SDLWindow):SDLWindowInitFlags;

	@:native("SDL_SetWindowTitle")
	static function setWindowTitle(window:SDLWindow, title:ConstCharStar):Void;

	@:native("SDL_GetWindowTitle")
	static function getWindowTitle(window:SDLWindow):ConstCharStar;

	@:native("SDL_SetWindowIcon")
	static function setWindowIcon(window:SDLWindow, icon:SDLSurface):Void;

	@:native("SDL_SetWindowData")
	static inline function setWindowData(window:SDLWindow, name:ConstCharStar, userdata:Any):Any {
		return untyped __cpp__("SDL_SetWindowData({0}, {1}, {2})", window, name, userdata);
	}

	@:native("SDL_GetWindowData")
	static inline function getWindowData(window:SDLWindow, name:ConstCharStar):Any {
		return untyped __cpp__("SDL_GetWindowData({0}, {1})", window, name);
	}

	@:native("SDL_GetWindowPosition")
	static inline function getWindowPosition(window:SDLWindow):SDLPoint {
		var winX:Int = 0;
		var winY:Int = 0;
	...
	static function setWindowPosition(window:SDLWindow, x:Int, y:Int):Void;

	@:native("SDL_GetWindowSize")
	static inline function getWindowSize(window:SDLWindow):SDLPoint {
		var sizeX:Int = 0;
		var sizeY:Int = 0;
	...
	static function setWindowSize(window:SDLWindow, x:Int, y:Int):Void;

	@:native("SDL_GetWindowBordersSize")
	static inline function getWindowBordersSize(window:SDLWindow):SDLRectangle {
		var top:Int = 0;
		var left:Int = 0;
		var bottom:Int = 0;
		var right:Int = 0;
		untyped __cpp__("SDL_GetWindowBordersSize({0}, {1}, {2}, {3})", RawPointer.addressOf(top), RawPointer.addressOf(left), RawPointer.addressOf(bottom),
			RawPointer.addressOf(right));
		return SDLRectangle.create(top, left, bottom, right);
	}

	@:native("SDL_GetWindowSizeInPixels")
	static inline function getWindowSizeInPixels(window:SDLWindow):SDLPoint {
		var width:Int = 0;
		var height:Int = 0;
	...
	static function setWindowMinimumSize(window:SDLWindow, minWidth:Int, minHeight:Int):Void;

	@:native("SDL_GetWindowMinimumSize")
	static inline function getWindowMinimumSize(window:SDLWindow):SDLPoint {
		var width:Int = 0;
		var height:Int = 0;
	...
	static function setWindowMaximumSize(window:SDLWindow, maxWidth:Int, maxHeight:Int):Void;

	@:native("SDL_GetWindowMaximumSize")
	static inline function getWindowMaximumSize(window:SDLWindow):SDLPoint {
		var width:Int = 0;
		var height:Int = 0;
	...
	static inline function setWindowBordered(window:SDLWindow, bordered:Bool):Void {
		untyped __cpp__("SDL_SetWindowBordered({0}, (SDL_bool){1})", window, bordered);
	}

	@:native("SDL_SetWindowResizable")
	static inline function setWindowResizable(window:SDLWindow, resizable:Bool):Void {
		untyped __cpp__("SDL_SetWindowResizable({0}, (SDL_bool){1})", window, resizable);
	}

	@:native("SDL_SetWindowAlwaysOnTop")
	static inline function setWindowAlwaysOnTop(window:SDLWindow, onTop:Bool):Void {
		untyped __cpp__("SDL_SetWindowAlwaysOnTop({0}, (SDL_bool){1})", window, onTop);
	}

	@:native("SDL_ShowWindow")
	static function showWindow(window:SDLWindow):Void;

	@:native("SDL_HideWindow")
	static function hideWindow(window:SDLWindow):Void;

	@:native("SDL_RaiseWindow")
	static function raiseWindow(window:SDLWindow):Void;

	@:native("SDL_MaximizeWindow")
	static function maximizeWindow(window:SDLWindow):Void;

	@:native("SDL_MinimizeWindow")
	static function minimizeWindow(window:SDLWindow):Void;

	@:native("SDL_RestoreWindow")
	static function restoreWindow(window:SDLWindow):Void;

	@:native("SDL_SetWindowFullscreen")
	static function setWindowFullscreen(window:SDLWindow, flags:SDLWindowInitFlags):Int;

	@:native("SDL_HasWindowSurface")
	static inline function hasWindowSurface(window:SDLWindow):Bool {
		return untyped __cpp__("SDL_HasWindowSurface({0})", window) == Boolean.TRUE;
	}

	@:native("SDL_GetWindowSurface")
	static function getWindowSurface(window:SDLWindow):SDLSurface;

	@:native("SDL_UpdateWindowSurface")
	static function updateWindowSurface(window:SDLWindow):Int;

	@:native("SDL_UpdateWindowSurfaceRects")
	static function updateWindowSurfaceRects(window:SDLWindow, rects:RawConstPointer<SDLRectangle>, numrects:Int):Int;

	@:native("SDL_DestroyWindowSurface")
	static function destroyWindowSurface(window:SDLWindow):Int;

	@:native("SDL_SetWindowGrab")
	static inline function setWindowGrab(window:SDLWindow, grabbed:Bool):Void {
		untyped __cpp__("SDL_SetWindowGrab({0}, (SDL_bool){1})", window, grabbed);
	}

	@:native("SDL_SetWindowKeyboardGrab")
	static inline function setWindowKeyboardGrab(window:SDLWindow, grabbed:Bool):Void {
		untyped __cpp__("SDL_SetWindowKeyboardGrab({0}, (SDL_bool){1})", window, grabbed);
	}

	@:native("SDL_SetWindowMouseGrab")
	static inline function setWindowMouseGrab(window:SDLWindow, grabbed:Bool):Void {
		untyped __cpp__("SDL_SetWindowMouseGrab({0}, (SDL_bool){1})", window, grabbed);
	}

	@:native("SDL_GetWindowGrab")
	static inline function getWindowGrab(window:SDLWindow):Bool {
		return untyped __cpp__("SDL_GetWindowGrab({0})", window) == Boolean.TRUE;
	}

	@:native("SDL_GetWindowKeyboardGrab")
	static inline function getWindowKeyboardGrab(window:SDLWindow):Bool {
		return untyped __cpp__("SDL_GetWindowKeyboardGrab({0})", window) == Boolean.TRUE;
	}

	@:native("SDL_GetWindowMouseGrab")
	static inline function getWindowMouseGrab(window:SDLWindow):Bool {
		return untyped __cpp__("SDL_GetWindowMouseGrab({0})", window) == Boolean.TRUE;
	}

	@:native("SDL_GetGrabbedWindow")
	static function getGrabbedWindow():SDLWindow;

	@:native("SDL_SetWindowMouseRect")
	static inline function setWindowMouseRect(window:SDLWindow, rect:SDLRectangle):Int {
		return untyped __cpp__("SDL_SetWindowMouseRect({0}, {1})", window, rect);
	}

	@:native("SDL_GetWindowMouseRect")
	static inline function getWindowMouseRect(window:SDLWindow):SDLRectangle {
		return untyped __cpp__("SDL_GetWindowMouseRect({0})", window);
	}

	@:native("SDL_SetWindowBrightness")
	static function setWindowBrightness(window:SDLWindow, brightness:Float):Int;

	@:native("SDL_GetWindowBrightness")
	static function getWindowBrightness(window:SDLWindow):Float;

	@:native("SDL_SetWindowOpacity")
	static function setWindowOpacity(window:SDLWindow, opacity:Float):Int;

	@:native("SDL_GetWindowOpacity")
	static inline function getWindowOpacity(window:SDLWindow):Float {
		untyped __cpp__("float _opac; SDL_GetWindowOpacity({0}, &_opac)", window);
		return untyped __cpp__("_opac");
	}

	@:native("SDL_SetWindowModalFor")
	static function setWindowModalFor(modalWindow:SDLWindow, parentWindow:SDLWindow):Int;

	@:native("SDL_SetWindowInputFocus")
	static function setWindowInputFocus(window:SDLWindow):Int;

	@:native("SDL_SetWindowGammaRamp")
	static function setWindowGammaRamp(window:SDLWindow, red:RawConstPointer<UInt16>, green:RawConstPointer<UInt16>, blue:RawConstPointer<UInt16>):Int;

	@:native("SDL_GetWindowGammaRamp")
	static function getWindowGammaRamp(window:SDLWindow, red:RawPointer<UInt16>, green:RawPointer<UInt16>, blue:RawPointer<UInt16>):Int;

	@:native("SDL_SetWindowHitTest")
	static inline function setWindowHitTest(window:SDLWindow, callback:SDLHitTest, callbackData:Any):Int {
		return untyped __cpp__("SDL_SetWindowHitTest({0}, {1}, {2})", window, callback, callbackData);
	}

	@:native("SDL_FlashWindow")
	static function flashWindow(window:SDLWindow, operation:SDLFlashOperation):Int;

	@:native("SDL_DestroyWindow")
	static function destroyWindow(window:SDLWindow):Void;
	...
	static function glLoadLibrary(path:ConstCharStar):Void;
	...
	static function glSetAttribute(attr:SDLGlAttribute, value:Int):Int;

	@:native("SDL_GL_GetAttribute")
	static inline function glGetAttribute(attr:SDLGlAttribute):Null<Int> {
		var result:Int = 0;
	...
	static function glCreateContext(window:SDLWindow):SDLGlContext;

	@:native("SDL_GL_MakeCurrent")
	static function glMakeCurrent(window:SDLWindow, context:SDLGlContext):Int;

	@:native("SDL_GL_GetCurrentWindow")
	static function glGetCurrentWindow():SDLWindow;

	@:native("SDL_GL_GetCurrentContext")
	static function glGetCurrentContext():SDLGlContext;

	@:native("SDL_GL_GetDrawableSize")
	static inline function glGetDrawableSize(window:SDLWindow):SDLPoint {
		var width:Int = 0;
		var height:Int = 0;
	...
	static function glSwapWindow(window:SDLWindow):Void;

	@:native("SDL_GL_DeleteContext")
	static function glDeleteContext(context:SDLGlContext):Void;
	...
	static inline function getRenderDriverInfo(displayIndex:Int):SDLRendererInfo {
		var result:Int = 0;
	...
	static function createRenderer(window:SDLWindow, index:Int, flags:SDLRendererFlags):SDLRenderer;

	@:native("SDL_CreateSoftwareRenderer")
	static function createSoftwareRenderer(surface:SDLSurface):SDLRenderer;

	@:native("SDL_GetRenderer")
	static function getRenderer(window:SDLWindow):SDLRenderer;

	@:native("SDL_RenderGetWindow")
	static function renderGetWindow(renderer:SDLWindow):SDLWindow;

	@:native("SDL_GetRendererInfo")
	static inline function getRendererInfo(renderer:SDLRenderer):SDLRendererInfo {
		var result:Int = 0;
	...
	static inline function getRendererOutputSize(renderer:SDLRenderer):SDLPoint {
		var width:Int = 0;
		var height:Int = 0;
	...
	static function createTexture(renderer:SDLRenderer, format:UInt32, access:Int, width:Int, height:Int):SDLTexture;

	@:native("SDL_CreateTextureFromSurface")
	static function createTextureFromSurface(renderer:SDLRenderer, surface:SDLSurface):SDLTexture;

	@:native("SDL_QueryTexture")
	static function queryTexture(texture:SDLTexture, format:RawPointer<SDLPixelFormatEnum>, access:RawPointer<Int>, width:RawPointer<Int>,
		height:RawPointer<Int>):Int;
	 ...
	 */
	@:native("SDL_QueryTexture")
	static inline function getTextureSize(texture:SDLTexture):SDLPoint {
		var w:Int = 0;
		var h:Int = 0;
	...
	static function setTextureColorMod(texture:SDLTexture, r:UInt8, g:UInt8, b:UInt8):Int;

	/**
	 * Alpha in returned color will always be 255
	 */
	@:native("SDL_GetTextureColorMod")
	static inline function getTextureColorMod(texture:SDLTexture):SDLColor {
		var r:UInt8 = 0;
		var g:UInt8 = 0;
		var b:UInt8 = 0;
	...
	static function setTextureAlphaMod(texture:SDLTexture, alpha:UInt8):Int;

	@:native("SDL_GetTextureAlphaMod")
	static inline function getTextureAlphaMod(texture:SDLTexture):UInt8 {
		var a:UInt8 = 0;
	...
	static function setTextureBlendMode(texture:SDLTexture, blend:SDLBlendMode):Int;

	@:native("SDL_GetTextureBlendMode")
	static inline function getTextureBlendMode(texture:SDLTexture):SDLBlendMode {
		var blend:SDLBlendMode = INVALID;
		untyped __cpp__("SDL_GetTextureBlendMode({0}, {1})", texture, RawPointer.addressOf(blend));
		return blend;
	}

	@:native("SDL_GetTextureScaleMode")
	static inline function getTextureScaleMode(texture:SDLTexture):SDLTextureScaleMode {
		var scaleMode:SDLTextureScaleMode = NEAREST;
	...
	static inline function setTextureScaleMode(texture:SDLTexture, scaleMode:SDLTextureScaleMode):Int {
		return untyped __cpp__("SDL_SetTextureScaleMode({0}, (SDL_ScaleMode){1})", texture, scaleMode);
	}

	@:native("SDL_SetTextureUserData")
	static function setTextureUserData(texture:SDLTexture, userdata:RawPointer<cpp.Void>):Int;

	@:native("SDL_GetTextureUserData")
	static function getTextureUserData(texture:SDLTexture):Any;

	@:native("SDL_UpdateTexture")
	static inline function updateTextureRaw(texture:SDLTexture, rect:RawConstPointer<SDLRectangle>, pixels:Any, pitch:Int) {
		return untyped __cpp__("SDL_UpdateTexture({0}, {1}, (void*){2}, {3})", texture, rect, pixels, pitch);
	}

	@:native("SDL_UpdateTexture")
	static inline function updateTexture(texture:SDLTexture, rect:SDLRectangle, pixels:Array<Any>, pitch:Int):Int {
		untyped __cpp__("
	...
	static inline function updateYUVTexture(texture:SDLTexture, rect:SDLRectangle, Yplane:Array<UInt8>, Ypitch:Int, Uplane:Array<UInt8>, Upitch:Int,
			Vplane:Array<UInt8>, Vpitch:Int):Int {
		untyped __cpp__("
		...
		return untyped __cpp__("SDL_UpdateYUVTexture({0}, {1}, _cArray, {2}, _cArray2, {3}, _cArray3, {4})", texture, RawConstPointer.addressOf(rect), Ypitch,
			Upitch, Vpitch);
	}

	@:native("SDL_UpdateNVTexture")
	static inline function updateNVTexture(texture:SDLTexture, rect:SDLRectangle, Yplane:Array<UInt8>, Ypitch:Int, UVplane:Array<UInt8>, UVpitch:Int):Int {
		untyped __cpp__("
		unsigned char* _cArray = (unsigned char*)malloc(sizeof(unsigned char) * {1});
		for (int i = 0; i < {1}; i++) {
			_cArray[i] = {0}->__get(i);
	...
	static inline function lockTexture(texture:SDLTexture, rect:SDLRectangle, pixels:Any, pitch:Int):Int {
		return untyped __cpp__("SDL_LockTexture({0}, {1})", texture, RawConstPointer.addressOf(rect), RawPointer.addressOf(pixels),
			RawPointer.addressOf(pitch));
	}

	@:native("SDL_LockTextureToSurface")
	static inline function lockTextureToSurface(texture:SDLTexture, rect:SDLRectangle, surface:SDLSurface):Int {
	...
	static function unlockTexture(texture:SDLTexture):Void;

	@:native("SDL_RenderTargetSupported")
	static inline function renderTargetSupported(renderer:SDLRenderer):Bool {
		return untyped __cpp__("SDL_RenderTargetSupported({0})", renderer) == Boolean.TRUE;
	}

	@:native("SDL_SetRenderTarget")
	static function setRenderTarget(renderer:SDLRenderer, texture:SDLTexture):Int;

	@:native("SDL_GetRenderTarget")
	static function getRenderTarget(renderer:SDLRenderer):SDLTexture;

	@:native("SDL_RenderSetLogicalSize")
	static function renderSetLogicalSize(renderer:SDLRenderer, w:Int, h:Int):Int;

	@:native("SDL_RenderGetLogicalSize")
	static inline function renderGetLogicalSize(renderer:SDLRenderer):SDLPoint {
		var width:Int = 0;
		var height:Int = 0;
	...
	static inline function renderIsClipEnabled(renderer:SDLRenderer):Bool {
		return untyped __cpp__("SDL_RenderIsClipEnabled({0})", renderer) == Boolean.TRUE;
	}

	@:native("SDL_RenderSetScale")
	static function renderSetScale(renderer:SDLRenderer, scaleX:Float, scaleY:Float):Int;

	@:native("SDL_RenderGetScale")
	static inline function renderGetScale(renderer:SDLRenderer):SDLFPoint {
		var scaleX:Float = 0;
		var scaleY:Float = 0;
	...
	static inline function renderWindowToLogical(renderer:SDLRenderer, windowX:Int, windowY:Int, logicalX:Float, logicalY:Float):Void {
		untyped __cpp__("SDL_RenderWindowToLogical({0}, {1}, {2}, {3}, {4})", renderer, windowX, windowY, RawPointer.addressOf(logicalX),
			RawPointer.addressOf(logicalY));
	}

	@:native("SDL_RenderLogicalToWindow")
	static inline function renderLogicalToWindow(renderer:SDLRenderer, logicalX:Float, logicalY:Float, windowX:Int, windowY:Int):Void {
		untyped __cpp__("SDL_RenderWindowToLogical({0}, {1}, {2}, {3}, {4})", renderer, RawPointer.addressOf(windowX), RawPointer.addressOf(windowY),
			logicalX, logicalY);
	}

	@:native("SDL_SetRenderDrawColor")
	static function setRenderDrawColor(renderer:SDLRenderer, r:UInt8, g:UInt8, b:UInt8, a:UInt8):Int;

	@:native("SDL_GetRenderDrawColor")
	static inline function getRenderDrawColor(renderer:SDLRenderer):SDLColor {
		var r:UInt8 = 0;
		var g:UInt8 = 0;
		var b:UInt8 = 0;
		var a:UInt8 = 0;
		untyped __cpp__("SDL_GetRenderDrawColor({0}, {1}, {2}, {3}, {4})", renderer, RawPointer.addressOf(r), RawPointer.addressOf(g),
			RawPointer.addressOf(b), RawPointer.addressOf(a));
		return SDLColor.create(r, g, b, a);
	}

	@:native("SDL_SetRenderDrawBlendMode")
	static inline function setRenderDrawBlendMode(renderer:SDLRenderer, blendMode:SDLBlendMode):Int {
		return untyped __cpp__("SDL_SetRenderDrawBlendMode({0}, (SDL_BlendMode){1})", renderer, blendMode);
	}

	@:native("SDL_GetRenderDrawBlendMode")
	static inline function getRenderDrawBlendMode(renderer:SDLRenderer, blendMode:SDLBlendMode):SDLBlendMode {
		var blendMode:SDLBlendMode = INVALID;
		untyped __cpp__("SDL_GetRenderDrawBlendMode({0}, {1})", renderer, RawPointer.addressOf(blendMode));
		return blendMode;
	}

	@:native("SDL_RenderClear")
	static function renderClear(renderer:SDLRenderer):Int;

	@:native("SDL_RenderDrawPoint")
	static function renderDrawPoint(renderer:SDLRenderer, x:Int, y:Int):Int;

	@:native("SDL_RenderDrawPoints")
	static inline function renderDrawPoints(renderer:SDLRenderer, points:Array<SDLPoint>, count:Int):Int {
		untyped __cpp__("
	...
	static function renderDrawLine(renderer:SDLRenderer, x1:Int, y1:Int, x2:Int, y2:Int):Int;

	@:native("SDL_RenderDrawLines")
	static inline function renderDrawLines(renderer:SDLRenderer, points:Array<SDLPoint>, count:Int):Int {
		untyped __cpp__("
		SDL_Point* _cArray = (SDL_Point*)malloc(sizeof(SDL_Point) * {1});
		for (int i = 0; i < {1}; i++) {
			_cArray[i] = {0}->__get(i);
	...
	static inline function renderDrawRect(renderer:SDLRenderer, rect:SDLRectangle):Int {
		return untyped __cpp__("SDL_RenderDrawRect({0}, {1})", renderer, RawConstPointer.addressOf(rect));
	}

	@:native("SDL_RenderDrawRects")
	static inline function renderDrawRects(renderer:SDLRenderer, rects:Array<SDLRectangle>, count:Int):Int {
		untyped __cpp__("
	...
	static inline function renderFillRect(renderer:SDLRenderer, rect:SDLRectangle):Int {
		return untyped __cpp__("SDL_RenderFillRect({0}, {1})", renderer, RawConstPointer.addressOf(rect));
	}

	@:native("SDL_RenderFillRects")
	static inline function renderFillRects(renderer:SDLRenderer, rects:RawConstPointer<SDLRectangle>, count:Int):Int {
		untyped __cpp__("
		SDL_Rect* _cArray = (SDL_Rect*)malloc(sizeof(SDL_Rect) * {1});
		for (int i = 0; i < {1}; i++) {
			_cArray[i] = {0}->__get(i);
	...
	static inline function renderCopy(renderer:SDLRenderer, texture:SDLTexture, src:SDLRectangle, dst:SDLRectangle):Int {
	...
	static inline function renderCopyEx(renderer:SDLRenderer, texture:SDLTexture, src:SDLRectangle, dst:SDLRectangle, angle:Float, center:SDLPoint,
			flip:SDLRendererFlip = NONE):Int {
		return untyped __cpp__("SDL_RenderCopyEx({0}, {1}, {2}, {3}, (double){4}, {5}, {6})", renderer, texture, RawConstPointer.addressOf(src),
			RawConstPointer.addressOf(dst), angle, RawConstPointer.addressOf(center), untyped __cpp__("(SDL_RendererFlip){0}", flip));
	}

	@:native("SDL_RenderDrawPointF")
	static function renderDrawPointF(renderer:SDLRenderer, x:Float, y:Float):Int;

	@:native("SDL_RenderDrawPointsF")
	static inline function renderDrawPointsF(renderer:SDLRenderer, points:Array<SDLFPoint>, count:Int):Int {
		untyped __cpp__("
	...
	static function renderDrawLineF(renderer:SDLRenderer, x1:Float, y1:Float, x2:Float, y2:Float):Int;

	@:native("SDL_RenderDrawLinesF")
	static inline function renderDrawLinesF(renderer:SDLRenderer, points:Array<SDLFPoint>, count:Int):Int {
		untyped __cpp__("
		SDL_FPoint* _cArray = (SDL_FPoint*)malloc(sizeof(SDL_FPoint) * {1});
		for (int i = 0; i < {1}; i++) {
			_cArray[i] = {0}->__get(i);
	...
	static inline function renderDrawRectF(renderer:SDLRenderer, rect:SDLFRectangle):Int {
		return untyped __cpp__("SDL_RenderDrawRectF({0}, {1})", renderer, RawConstPointer.addressOf(rect));
	}

	@:native("SDL_RenderDrawRectsF")
	static inline function renderDrawRectsF(renderer:SDLRenderer, rects:Array<SDLFRectangle>, count:Int):Int {
		untyped __cpp__("
	...
	static inline function renderFillRectF(renderer:SDLRenderer, rect:SDLFRectangle):Int {
		return untyped __cpp__("SDL_RenderFillRectF({0}, {1})", renderer, RawConstPointer.addressOf(rect));
	}

	@:native("SDL_RenderFillRectsF")
	static inline function renderFillRectsF(renderer:SDLRenderer, rects:Array<SDLFRectangle>, count:Int):Int {
		untyped __cpp__("
		SDL_FRect* _cArray = (SDL_FRect*)malloc(sizeof(SDL_FRect) * {1});
		for (int i = 0; i < {1}; i++) {
			_cArray[i] = {0}->__get(i);
	...
	static inline function renderCopyF(renderer:SDLRenderer, texture:SDLTexture, src:SDLRectangle, dst:SDLFRectangle):Int {
	...
	static inline function renderCopyExF(renderer:SDLRenderer, texture:SDLTexture, src:SDLRectangle, dst:SDLFRectangle, angle:Float, center:SDLFPoint,
			flip:SDLRendererFlip = NONE):Int {
		return untyped __cpp__("SDL_RenderCopyExF({0}, {1}, {2}, {3}, (double){4}, {5}, {6})", renderer, texture, RawConstPointer.addressOf(src),
			RawConstPointer.addressOf(dst), angle, RawConstPointer.addressOf(center), untyped __cpp__("(SDL_RendererFlip){0}", flip));
	}

	@:native("SDL_RenderGeometry")
	static inline function renderGeometry(renderer:SDLRenderer, texture:SDLTexture, vertices:Array< SDLVertex>,
			numVertices:Int, indices:Array<Int>, numIndices:Int):Int {
		untyped __cpp__("
	...
	static inline function renderGeometryRaw(renderer:SDLRenderer, texture:SDLTexture, xy:Array<Float>, xyStride:Int, color:Array<SDLColor>, colorStride:Int,
			uv:Array<Float>, uvStride:Int, numVertices:Int, indices:Array<Any>, numIndices:Int, sizeIndices:Int):Int {
		untyped __cpp__("
		...
		return untyped __cpp__("SDL_RenderGeometryRaw({0}, {1}, _xyArray, {2}, _colorArray, {3}, _uvArray, {4}, {5}, _indicesArray, {6}, {7})", renderer,
			texture, xyStride, colorStride, uvStride, numVertices, numIndices, sizeIndices);
	}

	@:native("SDL_RenderReadPixels")
	static inline function renderReadPixels(renderer:SDLRenderer, rect:SDLRectangle, format:SDLPixelFormat, pixels:Array<Any>, pitch:Int):Int {
		untyped __cpp__("
		void** _cArray = (void**)malloc(sizeof(void*) * {1});
		for (int i = 0; i < {1}; i++) {
			_cArray[i] = {0}->__get(i);
	...
	static function renderPresent(renderer:SDLRenderer):Void;

	@:native("SDL_DestroyTexture")
	static function destroyTexture(texture:SDLTexture):Void;

	@:native("SDL_DestroyRenderer")
	static function destroyRenderer(renderer:SDLRenderer):Void;

	@:native("SDL_RenderFlush")
	static function renderFlush(renderer:SDLRenderer):Int;

	@:native("SDL_GL_BindTexture")
	static inline function glBindTexture(texture:SDLTexture):Int {
		return untyped __cpp__("SDL_GL_BindTexture({0}, NULL, NULL)");
	}

	@:native("SDL_GL_UnbindTexture")
	static function glUnbindTexture(texture:SDLTexture):Int;

	@:native("SDL_RenderGetMetalLayer")
	static function renderGetMetalLayer(renderer:SDLRenderer):Any;

	@:native("SDL_RenderGetMetalCommandEncoder")
	static function renderGetMetalCommandEncoder(renderer:SDLRenderer):Any;

	@:native("SDL_RenderSetVSync")
	static function renderSetVSync(renderer:SDLRenderer, vsync:Int):Int;
	...
	static inline function pixelFormatEnumToMasks(format:UInt32, bitsPerPixel:Int, Rmask:UInt32, Gmask:UInt32, Bmask:UInt32, Amask:UInt32):Bool {
		return untyped __cpp__("SDL_PixelFormatEnumToMasks({0}, {1})", format, RawPointer.addressOf(bitsPerPixel), RawPointer.addressOf(Rmask),
			RawPointer.addressOf(Gmask), RawPointer.addressOf(Bmask), RawPointer.addressOf(Amask)) == Boolean.TRUE;
	}
	...
	static function allocFormat(pixelFormat:SDLPixelFormatEnum):SDLPixelFormat;

	@:native("SDL_FreeFormat")
	static function freeFormat(format:SDLPixelFormat):Void;

	@:native("SDL_AllocPalette")
	static function allocPalette(numColors:Int):SDLPalette;

	@:native("SDL_SetPixelFormatPalette")
	static function setPixelFormatPalette(format:SDLPixelFormat, palette:SDLPalette):Int;

	@:native("SDL_SetPaletteColors")
	static inline function setPaletteColors(palette:SDLPalette, colors:Array<SDLColor>, firstColor:Int, numColors:Int):Int {
		untyped __cpp__("
	...
	static function freePalette(palette:SDLPalette):Void;

	@:native("SDL_MapRGB")
	static function mapRGB(format:SDLPixelFormat, r:UInt8, g:UInt8, b:UInt8):UInt32;

	@:native("SDL_MapRGBA")
	static function mapRGBA(format:SDLPixelFormat, r:UInt8, g:UInt8, b:UInt8, a:UInt8):UInt32;

	@:native("SDL_GetRGB")
	static function getRGB(pixel:UInt32, format:SDLPixelFormat, r:RawPointer<UInt8>, g:RawPointer<UInt8>, b:RawPointer<UInt8>):Void;

	@:native("SDL_GetRGBA")
	static function getRGBA(pixel:UInt32, format:SDLPixelFormat, r:RawPointer<UInt8>, g:RawPointer<UInt8>, b:RawPointer<UInt8>, a:RawPointer<UInt8>):Void;
	...
	static inline function pointInRect(point:SDLPoint, rect:SDLRectangle):Bool {
		return untyped __cpp__("SDL_PointInRect(&{0}, &{1})", point, rect) == Boolean.TRUE;
	}

	@:native("SDL_RectEmpty")
	static inline function rectEmpty(rect:SDLRectangle):Bool {
		return untyped __cpp__("SDL_RectEmpty(&{0})", rect) == Boolean.TRUE;
	}

	@:native("SDL_RectEquals")
	static inline function rectEquals(a:SDLRectangle, b:SDLRectangle):Bool {
		return untyped __cpp__("SDL_RectEquals(&{0}, &{1})", a, b) == Boolean.TRUE;
	}

	@:native("SDL_HasIntersection")
	static inline function hasIntersection(a:SDLRectangle, b:SDLRectangle):Bool {
		return untyped __cpp__("SDL_HasIntersection(&{0}, &{1})", a, b) == Boolean.TRUE;
	}

	@:native("SDL_IntersectRect")
	static inline function intersectRect(a:SDLRectangle, b:SDLRectangle, result:SDLRectangle):Bool {
		return untyped __cpp__("SDL_IntersectRect(&{0}, &{1}, &{2})", a, b, result) == Boolean.TRUE;
	}

	@:native("SDL_UnionRect")
	static inline function unionRect(a:SDLRectangle, b:SDLRectangle, result:SDLRectangle):Void {
		untyped __cpp__("SDL_UnionRect(&{0}, &{1}, &{2})", a, b, result);
	}

	@:native("SDL_EnclosePoints")
	static inline function enclosePoints(points:Array<SDLPoint>, count:Int, clip:SDLRectangle, result:SDLRectangle):Int {
		untyped __cpp__("
	...
	static inline function intersectRectAndLine(rect:SDLRectangle, x1:Int, y1:Int, x2:Int, y2:Int):Bool {
		return untyped __cpp__("SDL_IntersectRectAndLine(&{0}, &{1}, &{2}, &{3}, &{4})", rect, x1, y1, x2, y2) == Boolean.TRUE;
	}

	@:native("SDL_PointInFRect")
	static inline function pointInFRect(point:SDLFPoint, rect:SDLFRectangle):Bool {
		return untyped __cpp__("SDL_PointInFRect(&{0}, &{1})", point, rect) == Boolean.TRUE;
	}

	@:native("SDL_FRectEmpty")
	static inline function fRectEmpty(rect:SDLFRectangle):Bool {
		return untyped __cpp__("SDL_FRectEmpty(&{0})", rect) == Boolean.TRUE;
	}

	@:native("SDL_FRectEqualsEpsilon")
	static inline function fRectEqualsEpsilon(a:SDLFRectangle, b:SDLFRectangle, epsilon:Float):Bool {
		return untyped __cpp__("SDL_FRectEqualsEpsilon(&{0}, &{1}, {2})", a, b, epsilon) == Boolean.TRUE;
	}

	@:native("SDL_FRectEquals")
	static inline function fRectEquals(a:SDLFRectangle, b:SDLFRectangle):Bool {
		return untyped __cpp__("SDL_FRectEquals(&{0}, &{1})", a, b) == Boolean.TRUE;
	}

	@:native("SDL_HasIntersectionF")
	static inline function hasIntersectionF(a:SDLFRectangle, b:SDLFRectangle):Bool {
		return untyped __cpp__("SDL_HasIntersectionF(&{0}, &{1})", a, b) == Boolean.TRUE;
	}

	@:native("SDL_IntersectFRect")
	static inline function intersectFRect(a:SDLFRectangle, b:SDLFRectangle, result:SDLFRectangle):Bool {
		return untyped __cpp__("SDL_IntersectFRect(&{0}, &{1}, &{2})", a, b, result) == Boolean.TRUE;
	}

	@:native("SDL_UnionFRect")
	static inline function unionFRect(a:SDLFRectangle, b:SDLFRectangle, result:SDLFRectangle):Void {
		untyped __cpp__("SDL_UnionFRect(&{0}, &{1}, &{2})", a, b, result);
	}

	@:native("SDL_UnionFRect")
	static inline function encloseFPoints(points:Array<SDLFPoint>, count:Int, clip:SDLFRectangle, result:SDLFRectangle):Int {
		untyped __cpp__("
	...
	static inline function intersectFRectAndLine(rect:SDLFRectangle, x1:Float, y1:Float, x2:Float, y2:Float):Bool {
		return untyped __cpp__("SDL_IntersectFRectAndLine(&{0}, &{1}, &{2}, &{3}, &{4})", rect, x1, y1, x2, y2) == Boolean.TRUE;
	}

	// SDL_surface.h //
	@:native("SDL_CreateRGBSurface")
	static inline function createRGBSurface(width:Int, height:Int, depth:Int, Rmask:UInt32, Gmask:UInt32, Bmask:UInt32):SDLSurface {
	...
	static inline function createRGBSurfaceWithFormat(width:Int, height:Int, depth:Int, format:SDLPixelFormatEnum):SDLSurface {
	...
	static inline function createRGBSurfaceFromRaw(pixels:Any, width:Int, height:Int, depth:Int, pitch:Int, Rmask:UInt32, Gmask:UInt32,
			Bmask:UInt32):SDLSurface {
		return untyped __cpp__("SDL_CreateRGBSurfaceFrom((void*){0}, {1}, {2}, {3}, {4}, {5}, {6}, {7})", pixels, width, height, depth, pitch, Rmask, Gmask,
			Bmask);
	}

	@:native("SDL_CreateRGBSurfaceFrom")
	static inline function createRGBSurfaceFrom(pixels:Array<Any>, width:Int, height:Int, depth:Int, pitch:Int, Rmask:UInt32, Gmask:UInt32,
			Bmask:UInt32):SDLSurface {
		untyped __cpp__("
		void** _cArray = (void**)malloc(sizeof(void*) * {1});
		for (int i = 0; i < {1}; i++) {
	...
	static inline function createRGBSurfaceWithFormatFromRaw(pixels:Any, width:Int, height:Int, depth:Int, pitch:Int,
			format:SDLPixelFormat):SDLSurface {
		return untyped __cpp__("SDL_CreateRGBSurfaceWithFormatFrom((void*){0}, {1}, {2}, {3}, {4}, (SDL_PixelFormatEnum){5})", pixels, width, height, depth,
			pitch, format);
	}

	@:native("SDL_CreateRGBSurfaceWithFormatFrom")
	static inline function createRGBSurfaceWithFormatFrom(pixels:Array<Any>, width:Int, height:Int, depth:Int, pitch:Int,
			format:SDLPixelFormat):SDLSurface {
		untyped __cpp__("
		void** _cArray = (void**)malloc(sizeof(void*) * {1});
		for (int i = 0; i < {1}; i++) {
		...
		return untyped __cpp__("SDL_CreateRGBSurfaceWithFormatFrom(_cArray, {0}, {1}, {2}, {3}, (SDL_PixelFormatEnum){4})", width, height, depth, pitch,
			format);
	}

	@:native("SDL_FreeSurface")
	static function freeSurface(surface:SDLSurface):Void;

	@:native("SDL_SetSurfacePalette")
	static inline function setSurfacePalette(surface:SDLSurface, palette:SDLPalette):Bool {
		return untyped __cpp__("SDL_SetSurfacePalette({0}, {1})", surface, palette) == Boolean.TRUE;
	}

	@:native("SDL_LockSurface")
	static function lockSurface(surface:SDLSurface):Void;

	@:native("SDL_UnlockSurface")
	static function unlockSurface(surface:SDLSurface):Void;

	@:native("SDL_LoadBMP_RW")
	static function loadBMPRW(src:SDLRWops, freesrc:Int):Void;

	@:native("SDL_LoadBMP")
	static function loadBMP(file:ConstCharStar):Void;

	@:native("SDL_SaveBMP_RW")
	static function saveBMPRW(src:SDLRWops, dst:SDLRWops, freesrc:Int):Void;

	@:native("SDL_SaveBMP")
	static function saveBMP(surface:SDLSurface, file:ConstCharStar):Void;

	@:native("SDL_SetSurfaceRLE")
	static function setSurfaceRLE(surface:SDLSurface, flag:Int):Int;

	@:native("SDL_HasSurfaceRLE")
	static inline function hasSurfaceRLE(surface:SDLSurface):Bool {
		return untyped __cpp__("SDL_HasSurfaceRLE({0})", surface) == Boolean.TRUE;
	}

	@:native("SDL_SetColorKey")
	static function setColorKey(surface:SDLSurface, flag:Int, key:UInt32):Int;

	@:native("SDL_HasColorKey")
	static inline function hasColorKey(surface:SDLSurface):Bool {
		return untyped __cpp__("SDL_HasColorKey({0})", surface) == Boolean.TRUE;
	}

	@:native("SDL_GetColorKey")
	static inline function getColorKey(surface:SDLSurface):UInt32 {
		untyped __cpp__("unsigned int _key; SDL_GetColorKey({0}, &_key)", surface);
		return untyped __cpp__("_key");
	}

	@:native("SDL_SetSurfaceColorMod")
	static function setSurfaceColorMod(surface:SDLSurface, r:UInt8, g:UInt8, b:UInt8):Int;

	/**
	 * Alpha in returned color will always be 255
	 */
	@:native("SDL_GetSurfaceColorMod")
	static inline function getSurfaceColorMod(surface:SDLSurface):SDLColor {
		var r:UInt8 = 0;
		var g:UInt8 = 0;
		var b:UInt8 = 0;
	...
	static function setSurfaceAlphaMod(surface:SDLSurface, alpha:UInt8):Int;

	@:native("SDL_GetSurfaceAlphaMod")
	static inline function getSurfaceAlphaMod(surface:SDLSurface):UInt8 {
		var a:UInt8 = 0;
	...
	static function setSurfaceBlendMode(surface:SDLSurface, blend:SDLBlendMode):Int;

	@:native("SDL_GetSurfaceBlendMode")
	static inline function getSurfaceBlendMode(surface:SDLSurface):SDLBlendMode {
		var blend:SDLBlendMode = INVALID;
	...
	static inline function setClipRect(surface:SDLSurface, rect:SDLRectangle):Bool {
		return untyped __cpp__("SDL_SetClipRect({0}, {1})", surface, RawConstPointer.addressOf(rect)) == Boolean.TRUE;
	}

	@:native("SDL_GetClipRect")
	static inline function getClipRect(surface:SDLSurface):SDLRectangle {
		var rect:SDLRectangle = null;
	...
	static function duplicateSurface(surface:SDLSurface):SDLSurface;

	@:native("SDL_ConvertSurface")
	static inline function convertSurface(surface:SDLSurface, format:SDLPixelFormat):SDLSurface {
		return untyped __cpp__("SDL_ConvertSurface({0}, {1}, 0)", surface, RawConstPointer.addressOf(format));
	}

	@:native("SDL_ConvertSurfaceFormat")
	static inline function convertSurfaceFormat(surface:SDLSurface, format:SDLPixelFormat):SDLSurface {
		return untyped __cpp__("SDL_ConvertSurfaceFormat({0}, (SDL_PixelFormatEnum){1}, 0)", surface, format);
	}

	@:native("SDL_ConvertPixels")
	static inline function convertPixelsRaw(width:Int, height:Int, srcFormat:SDLPixelFormat, src:Any, srcPitch:Int,
			dstFormat:SDLPixelFormat, dst:Any, dstPitch:Int):Int {
		return untyped __cpp__("SDL_ConvertPixels({0}, {1}, (SDL_PixelFormatEnum){2}, {3}, {4}, (SDL_PixelFormatEnum){5}, {6}, {7})");
	}

	@:native("SDL_ConvertPixels")
	static inline function convertPixels(width:Int, height:Int, srcFormat:SDLPixelFormat, src:Array<Any>,
			srcPitch:Int, dstFormat:SDLPixelFormat, dst:Array<Any>, dstPitch:Int):Int {
		untyped __cpp__("
		...
		return untyped __cpp__("SDL_ConvertPixels({0}, {1}, (SDL_PixelFormatEnum){2}, _srcArr, {3}, (SDL_PixelFormatEnum){4}, _dstArr, {5})", width, height,
			srcFormat, srcPitch, dstFormat, dstPitch);
	}

	@:native("SDL_PremultiplyAlpha")
	static inline function premultiplyAlpha(width:Int, height:Int, srcFormat:SDLPixelFormat, src:Array<Any>,
			srcPitch:Int, dstFormat:SDLPixelFormat, dst:Array<Any>, dstPitch:Int):Int {
		untyped __cpp__("
		void** _srcArr = (void**)malloc(sizeof(void*) * {1});
		for (int i = 0; i < {1}; i++) {
		...
		return untyped __cpp__("SDL_PremultiplyAlpha({0}, {1}, (SDL_PixelFormatEnum){2}, _srcArr, {3}, (SDL_PixelFormatEnum){4}, _dstArr, {5})", width,
			height, srcFormat, srcPitch, dstFormat, dstPitch);
	}

	@:native("SDL_FillRect")
	static inline function fillRect(dst:SDLSurface, rect:SDLRectangle, color:UInt32):Int {
		return untyped __cpp__("SDL_FillRect({0}, {1}, {2})", dst, RawConstPointer.addressOf(rect), color);
	}

	@:native("SDL_FillRects")
	static inline function fillRects(dst:SDLSurface, rects:Array<SDLRectangle>, count:Int, color:UInt32):Int {
		untyped __cpp__("
	...
	static inline function blitSurface(src:SDLSurface, srcRect:SDLRectangle, dst:SDLSurface, dstRect:SDLRectangle):Int {
	...
	static inline function lowerBlit(src:SDLSurface, srcRect:SDLRectangle, dst:SDLSurface, dstRect:SDLRectangle):Int {
	...
	static inline function softStretch(src:SDLSurface, srcRect:SDLRectangle, dst:SDLSurface, dstRect:SDLRectangle):Int {
	...
	static inline function softStretchLinear(src:SDLSurface, srcRect:SDLRectangle, dst:SDLSurface, dstRect:SDLRectangle):Int {
	...
	static inline function blitScaled(src:SDLSurface, srcRect:SDLRectangle, dst:SDLSurface, dstRect:SDLRectangle):Int {
	...
	static inline function lowerBlitScaled(src:SDLSurface, srcRect:SDLRectangle, dst:SDLSurface, dstRect:SDLRectangle):Int {
	...
	static function setYUVConversionMode(mode:SDLYUVConversionMode):Void;

	@:native("SDL_GetYUVConversionMode")
	static function getYUVConversionMode():SDLYUVConversionMode;

	@:native("SDL_GetYUVConversionModeForResolution")
	static function getYUVConversionModeForResolution(width:Int, height:Int):SDLYUVConversionMode;

	// SDL_syswm.h //
	@:native("SDL_GetWindowWMInfo")
	static inline function getWindowWMInfo(window:SDLWindow) {
	...
	static function peepEvents(events:SDLEvent, numEvents:Int, action:SDLEventAction,
		minType:SDLEventType, maxType:SDLEventType):Void;

	@:native("SDL_HasEvent")
	static inline function hasEvent(type:SDLEventType):Bool {
		return untyped __cpp__("SDL_HasEvent({0})", type) == Boolean.TRUE;
	}

	@:native("SDL_HasEvents")
	static inline function hasEvents(minType:SDLEventType, maxType:SDLEventType):Bool {
	...
	static function flushEvents(minType:SDLEventType, maxType:SDLEventType):Void;

	@:native("SDL_PollEvent")
	static function pollEvent(event:SDLEvent):Int;

	@:native("SDL_WaitEvent")
	static function waitEvent(event:SDLEvent):Int;

	@:native("SDL_WaitEventTimeout")
	static function waitEventTimeout(event:SDLEvent, timeout:Int):Int;

	@:native("SDL_PushEvent")
	static function pushEvent(event:SDLEvent):Int;

	@:native("SDL_SetEventFilter")
	static inline function setEventFilter(filter:SDLEventFilter, userdata:Any):Void {
	...
	static inline function addEventWatch(filter:SDLEventFilter, userdata:Any):Void {
		return untyped __cpp__("SDL_AddEventWatch({0}, (void*){1})", filter, userdata);
	}

	@:native("SDL_DelEventWatch")
	static inline function deleteEventWatch(filter:SDLEventFilter, userdata:Any):Void {
		return untyped __cpp__("SDL_DelEventWatch({0}, (void*){1})", filter, userdata);
	}

	@:native("SDL_FilterEvents")
	static inline function filterEvents(filter:SDLEventFilter, userdata:Any):Void {
		return untyped __cpp__("SDL_FilterEvents({0}, (void*){1})", filter, userdata);
	}

	@:native("SDL_EventState")
	static function eventState(type:SDLEventType, state:SDLEventState):UInt8;

	@:native("SDL_GetEventState")
	static function getEventState(type:SDLEventType):UInt8;
	...
	static function getKeyboardFocus():SDLWindow;

	@:native("SDL_GetKeyboardState")
	static inline function getKeyboardStates(numKeys:Int):Array< SDLKeyState> {
		var sdlKeyStates:CArray< SDLKeyState> = untyped __cpp__("*SDL_GetKeyboardState({0})", GAYSEX.addressOf(numKeys));
		var stateCount:Int = Helpers.lengthOfArray(sdlKeyStates);

		var haxeKeyStates:Array< SDLKeyState> = NativeArray.create(stateCount);
	...
	static function getKeyModState():SDLKeyMod; // mod = keyMod, explains the function better

	@:native("SDL_SetModState")
	static function setKeyModState(modState:SDLKeyMod):Void; // mod = keyMod, explains the function better

	@:native("SDL_GetKeyFromScancode")
	static function getKeyFromScancode(scancode:SDLScanCode):SDLKeyCode;

	@:native("SDL_GetScancodeFromKey")
	static function getScancodeFromKey(key:SDLKeyCode):SDLScanCode;

	@:native("SDL_GetScancodeName")
	static function getScancodeName(scancode:SDLScanCode):ConstCharStar;

	@:native("SDL_GetScancodeFromName")
	static function getScancodeFromName(name:ConstCharStar):SDLScanCode;

	@:native("SDL_GetKeyName")
	static function getKeyName(key:SDLKeyCode):ConstCharStar;

	@:native("SDL_GetKeyFromName")
	static function getKeyFromName(name:ConstCharStar):SDLKeyCode;
	...
	static inline function setTextInputRect(rect:SDLRectangle):Void {
	...
	static inline function getRelativeMouseState(x:Int, y:Int):SDLMouseButton {
	...
	static function warpMouseInWindow(window:SDLWindow, x:Int, y:Int):Void;
	...
	static inline function createCursor(data:UInt8, mask:UInt8, width:Int, height:Int, hotX:Int, hotY:Int):SDLCursor {
		return untyped __cpp__("SDL_CreateCursor({0}, {1}, {2}, {3}, {4}, {5})", RawPointer.addressOf(data), RawPointer.addressOf(mask), width, height, hotX,
			hotY);
	}

	@:native("SDL_CreateColorCursor")
	static function createColorCursor(surface:SDLSurface, hotX:Int, hotY:Int):SDLCursor;

	@:native("SDL_CreateSystemCursor")
	static function createSystemCursor(id:SDLSystemCursor):SDLCursor;

	@:native("SDL_SetCursor")
	static function setCursor(cursor:SDLCursor):Void;

	@:native("SDL_GetCursor")
	static function getCursor():SDLCursor;

	@:native("SDL_GetDefaultCursor")
	static function getDefaultCursor():SDLCursor;

	@:native("SDL_FreeCursor")
	static function freeCursor(cursor:SDLCursor):Void;
	...
	static function joystickGetDeviceGUID(deviceIndex:Int):SDLJoystickGUID;
	...
	static function joystickGetDeviceType(deviceIndex:Int):SDLJoystickType;

	@:native("SDL_JoystickGetDeviceInstanceID")
	static function joystickGetDeviceInstanceID(deviceIndex:Int):SDLJoystickID;

	@:native("SDL_JoystickOpen")
	static function joystickOpen(deviceIndex:Int):SDLJoystick ;

	@:native("SDL_JoystickFromInstanceID")
	static function joystickFromInstanceID(instanceIndex:Int):SDLJoystick ;

	@:native("SDL_JoystickFromPlayerIndex")
	static function joystickFromPlayerIndex(playerIndex:Int):SDLJoystick ;

	@:native("SDL_JoystickAttachVirtual")
	static function joystickAttachVirtual(type:SDLJoystickType, nAxes:Int, nButtons:Int, nHats:Int):Int;

	@:native("SDL_JoystickAttachVirtualEx")
	static function joystickAttachVirtualEx(desc:RawConstPointer< SDLRawVirtualJoystickDesc>):Int;
	...
	static function joystickSetVirtualAxis(joystick:SDLJoystick , axis:Int, value:Int16):Int;

	@:native("SDL_JoystickSetVirtualButton")
	static function joystickSetVirtualButton(joystick:SDLJoystick , button:Int, value:Int16):Int;

	@:native("SDL_JoystickSetVirtualHat")
	static function joystickSetVirtualHat(joystick:SDLJoystick , hat:Int, value:Int16):Int;

	@:native("SDL_JoystickName")
	static function joystickName(joystick:SDLJoystick ):ConstCharStar;

	@:native("SDL_JoystickPath")
	static function joystickPath(joystick:SDLJoystick ):ConstCharStar;

	@:native("SDL_JoystickGetPlayerIndex")
	static function joystickGetPlayerIndex(joystick:SDLJoystick ):Int;

	@:native("SDL_JoystickSetPlayerIndex")
	static function joystickSetPlayerIndex(joystick:SDLJoystick , playerIndex:Int):Void;

	@:native("SDL_JoystickGetGUID")
	static function joystickGetGUID(joystick:SDLJoystick ):SDLJoystickGUID;

	@:native("SDL_JoystickGetVendor")
	static function joystickGetVendor(joystick:SDLJoystick ):UInt16;

	@:native("SDL_JoystickGetProduct")
	static function joystickGetProduct(joystick:SDLJoystick ):UInt16;

	@:native("SDL_JoystickGetProductVersion")
	static function joystickGetProductVersion(joystick:SDLJoystick ):UInt16;

	@:native("SDL_JoystickGetFirmwareVersion")
	static function joystickGetFirmwareVersion(joystick:SDLJoystick ):UInt16;

	@:native("SDL_JoystickGetSerial")
	static function joystickGetSerial(joystick:SDLJoystick ):ConstCharStar;

	@:native("SDL_JoystickGetType")
	static function joystickGetType(joystick:SDLJoystick ):SDLJoystickType;

	@:native("SDL_JoystickGetGUIDString")
	static inline function joystickGetGUIDString(guid:SDLJoystickGUID):CastCharStar {
	...
	static function joystickGetGUIDFromString(pchGUID:ConstCharStar):SDLJoystickGUID;

	@:native("SDL_getJoystickGUIDInfo")
	static inline function getJoystickGUIDInfo(guid:SDLJoystickGUID):{
		vendor:UInt16,
		product:UInt16,
		version:UInt16,
		crc16:UInt16
		...
		var crc16:UInt16 = 0;
		untyped __cpp__("SDL_GetJoystickGUIDInfo({0}, {1}, {2}, {3}, {4})", guid, RawPointer.addressOf(vendor), RawPointer.addressOf(product),
			RawPointer.addressOf(version), RawPointer.addressOf(crc16));
		return {
			vendor: vendor,
			product: product,
			version: version,
	...
	static inline function joystickGetAttached(joystick:SDLJoystick ):Bool {
		return untyped __cpp__("SDL_JoystickGetAttached({0})", joystick) == Boolean.TRUE;
	}

	@:native("SDL_JoystickInstanceID")
	static function joystickInstanceID(joystick:SDLJoystick ):SDLJoystickID;

	@:native("SDL_JoystickNumAxes")
	static function joystickNumAxes(joystick:SDLJoystick ):Int;

	@:native("SDL_JoystickNumBalls")
	static function joystickNumBalls(joystick:SDLJoystick ):Int;

	@:native("SDL_JoystickNumHats")
	static function joystickNumHats(joystick:SDLJoystick ):Int;

	@:native("SDL_JoystickNumButtons")
	static function joystickNumButtons(joystick:SDLJoystick ):Int;
	...
	static function joystickGetAxis(joystick:SDLJoystick , axis:Int):Int16;

	@:native("SDL_JoystickGetAxisInitialState")
	static inline function joystickGetAxisInitialState(joystick:SDLJoystick , axis:Int):Int16 {
		var state:Int16 = 0;
	...
	static function joystickGetHat(joystick:SDLJoystick , hat:Int):UInt8;

	@:native("SDL_JoystickGetBall")
	static inline function joystickGetBall(joystick:SDLJoystick , ball:Int):SDLPoint {
		var dx:Int = 0;
		var dy:Int = 0;
	...
	static function joystickGetButton(joystick:SDLJoystick , button:Int):UInt8;

	@:native("SDL_JoystickRumble")
	static function joystickRumble(joystick:SDLJoystick , lowFrequencyRumble:UInt16, highFrequencyRumble:UInt16,
		durationMS:UInt32):UInt8;

	@:native("SDL_JoystickHasLED")
	static inline function joystickHasLED(joystick:SDLJoystick ):Bool {
		return untyped __cpp__("SDL_JoystickHasLED({0})", joystick) == Boolean.TRUE;
	}

	@:native("SDL_JoystickHasRumble")
	static inline function joystickHasRumble(joystick:SDLJoystick ):Bool {
		return untyped __cpp__("SDL_JoystickHasRumble({0})", joystick) == Boolean.TRUE;
	}

	@:native("SDL_JoystickHasRumbleTriggers")
	static inline function joystickHasRumbleTriggers(joystick:SDLJoystick ):Bool {
		return untyped __cpp__("SDL_JoystickHasRumbleTriggers({0})", joystick) == Boolean.TRUE;
	}

	@:native("SDL_JoystickSetLED")
	static function joystickSetLED(joystick:SDLJoystick , red:UInt8, green:UInt8, blue:UInt8):Int;

	@:native("SDL_JoystickSendEffect")
	static inline function joystickSendEffect(joystick:SDLJoystick , data:Any, size:Int):Int {
		return untyped __cpp__("SDL_JoystickSendEffect({0}, (const void*){1}, {2})", joystick, data, size);
	}

	@:native("SDL_JoystickClose")
	static function joystickClose(joystick:SDLJoystick ):Void;

	@:native("SDL_JoystickCurrentPowerLevel")
	static function joystickCurrentPowerLevel(joystick:SDLJoystick ):SDLJoystickPowerLevel ;
	...
	static function gameControllerAddMappingsFromRW(rw:SDLRWops, freerw:Int):Int;
	...
	static function gameControllerMappingForGUID(guid:SDLJoystickGUID):CastCharStar;

	@:native("SDL_GameControllerMapping")
	static function gameControllerMapping(gameController:SDLGameController):CastCharStar;
	...
	static function gameControllerTypeForIndex(joystickIndex:Int):SDLGameControllerType ;
	...
	static function gameControllerOpen(joystickIndex:Int):SDLGameController;

	@:native("SDL_GameControllerFromInstanceID")
	static function gameControllerFromInstanceID(joystickID:SDLJoystickID):SDLGameController;

	@:native("SDL_GameControllerFromPlayerIndex")
	static function gameControllerFromPlayerIndex(playerIndex:Int):SDLGameController;

	@:native("SDL_GameControllerName")
	static function gameControllerName(gameController:SDLGameController):ConstCharStar;

	@:native("SDL_GameControllerPath")
	static function gameControllerPath(gameController:SDLGameController):ConstCharStar;

	@:native("SDL_GameControllerGetType")
	static function gameControllerGetType(gameController:SDLGameController):SDLGameControllerType ;

	@:native("SDL_GameControllerGetPlayerIndex")
	static function gameControllerGetPlayerIndex(gameController:SDLGameController):Int;

	@:native("SDL_GameControllerSetPlayerIndex")
	static function gameControllerSetPlayerIndex(gameController:SDLGameController, playerIndex:Int):Void;

	@:native("SDL_GameControllerGetVendor")
	static function gameControllerGetVendor(gameController:SDLGameController):UInt16;

	@:native("SDL_GameControllerGetProduct")
	static function gameControllerGetProduct(gameController:SDLGameController):UInt16;

	@:native("SDL_GameControllerGetProductVersion")
	static function gameControllerGetProductVersion(gameController:SDLGameController):UInt16;

	@:native("SDL_GameControllerGetFirmwareVersion")
	static function gameControllerGetFirmwareVersion(gameController:SDLGameController):UInt16;

	@:native("SDL_GameControllerGetSerial")
	static function gameControllerGetSerial(gameController:SDLGameController):ConstCharStar;

	@:native("SDL_GameControllerGetSteamHandle")
	static function gameControllerGetSteamHandle(gameController:SDLGameController):UInt64;

	@:native("SDL_GameControllerGetAttached")
	static inline function gameControllerGetAttached(gameController:SDLGameController):Bool {
		return untyped __cpp__("SDL_GameControllerGetAttached({0})", gameController) == Boolean.TRUE;
	}

	@:native("SDL_GameControllerGetJoystick")
	static function gameControllerGetJoystick(gameController:SDLGameController):SDLJoystick ;
	...
	static function gameControllerGetAxisFromString(str:ConstCharStar):SDLGameControllerAxis;

	@:native("SDL_GameControllerGetStringForAxis")
	static function gameControllerGetStringForAxis(axis:SDLGameControllerAxis):ConstCharStar;

	@:native("SDL_GameControllerGetBindForAxis")
	static function gameControllerGetBindForAxis(gameController:SDLGameController,
		axis:SDLGameControllerAxis):SDLGameControllerButtonBind;

	@:native("SDL_GameControllerHasAxis")
	static inline function gameControllerHasAxis(gameController:SDLGameController,
			axis:SDLGameControllerAxis):Bool {
	...
	static function gameControllerGetAxis(gameController:SDLGameController,
		axis:SDLGameControllerAxis):Int16;

	@:native("SDL_GameControllerGetButtonFromString")
	static function gameControllerGetButtonFromString(str:ConstCharStar):SDLGameControllerButton;

	@:native("SDL_GameControllerGetStringForButton")
	static function gameControllerGetStringForButton(button:SDLGameControllerButton):ConstCharStar;

	@:native("SDL_GameControllerGetBindForButton")
	static function gameControllerGetBindForButton(gameController:SDLGameController,
		button:SDLGameControllerButton):SDLGameControllerButtonBind;

	@:native("SDL_GameControllerHasButton")
	static inline function gameControllerHasButton(gameController:SDLGameController,
			button:SDLGameControllerButton):Bool {
	...
	static function gameControllerGetButton(gameController:SDLGameController,
		button:SDLGameControllerButton):Int16;

	@:native("SDL_GameControllerGetNumTouchpads")
	static function gameControllerGetNumTouchpads(gameController:SDLGameController):Int;

	@:native("SDL_GameControllerGetNumTouchpadFingers")
	static function gameControllerGetNumTouchpadFingers(gameController:SDLGameController, touchpad:Int):Int;

	@:native("SDL_GameControllerGetNumTouchpadFinger")
	static function gameControllerGetNumTouchpadFinger(gameController:SDLGameController, touchpad:Int, finger:Int):Int;

	@:native("SDL_GameControllerHasSensor")
	static inline function gameControllerHasSensor(gameController:SDLGameController,
			type:SDLSensorType):Bool {
	...
	static inline function gameControllerSetSensor(gameController:SDLGameController,
			type:SDLSensorType, enabled:Bool):Int {
	...
	static inline function gameControllerIsSensorEnabled(gameController:SDLGameController,
			type:SDLSensorType):Bool {
	...
	static inline function gameControllerGetSensorDataRate(gameController:SDLGameController,
			type:SDLSensorType):Single {
	...
	static inline function gameControllerGetSensorData(gameController:SDLGameController,
			type:SDLSensorType, numValues:Int):Single {
		var data:Single = 0;
	...
	static inline function gameControllerGetSensorDataWithTimestamp(gameController:SDLGameController,
			type:SDLSensorType, numValues:Int):{data:Single, timestamp:UInt64
	} {
		var data:Single = 0;
		var timestamp:UInt64 = 0;
		untyped __cpp__("SDL_GameControllerGetSensorDataWithTimestamp({0}, (SDL_SensorType){1}, {2}, {3}, {4})", gameController, type,
			RawPointer.addressOf(timestamp), RawPointer.addressOf(data), numValues);
		return {
			data: data,
			timestamp: timestamp
		};
	...
	static function gameControllerRumble(gameController:SDLGameController, lowFrequencyRumble:UInt16,
		highFrequencyRumble:UInt16, durationMS:UInt32):Int;

	@:native("SDL_GameControllerRumbleTriggers")
	static function gameControllerRumbleTriggers(gameController:SDLGameController, leftRumble:UInt16,
		rightRumble:UInt16, durationMS:UInt32):Int;

	@:native("SDL_GameControllerHasLED")
	static inline function gameControllerHasLED(gameController:SDLGameController):Bool {
		return untyped __cpp__("SDL_GameControllerHasLED({0})", gameController) == Boolean.TRUE;
	}

	@:native("SDL_GameControllerHasRumble")
	static inline function gameControllerHasRumble(gameController:SDLGameController):Bool {
	...
	static inline function gameControllerHasRumbleTriggers(gameController:SDLGameController):Bool {
		return untyped __cpp__("SDL_GameControllerHasRumbleTriggers({0})", gameController) == Boolean.TRUE;
	}

	@:native("SDL_GameControllerSetLED")
	static function gameControllerSetLED(gameController:SDLGameController, red:UInt8, green:UInt8, blue:UInt8):Int;

	@:native("SDL_GameControllerSendEffect")
	static inline function gameControllerSendEffect(gameController:SDLGameController, data:Any, size:Int):Int {
	...
	static function gameControllerClose(gameController:SDLGameController):Void;

	@:native("SDL_GameControllerGetAppleSFSymbolsNameForButton")
	static function gameControllerGetAppleSFSymbolsNameForButton(gameController:SDLGameController,
		button:SDLGameControllerButton):ConstCharStar;

	@:native("SDL_GameControllerGetAppleSFSymbolsNameForAxis")
	static function gameControllerGetAppleSFSymbolsNameForAxis(gameController:SDLGameController,
		axis:SDLGameControllerAxis):ConstCharStar;
	...
	static function sensorGetDeviceType(deviceIndex:Int):SDLSensorType;
	...
	static function sensorGetDeviceInstanceID(deviceIndex:Int):SDLSensorID;

	@:native("SDL_SensorOpen")
	static function sensorOpen(deviceIndex:Int):SDLSensor;

	@:native("SDL_SensorFromInstanceID")
	static function sensorFromInstanceID(instanceID:Int):SDLSensor;

	@:native("SDL_SensorGetName")
	static function sensorGetName(sensor:SDLSensor):ConstCharStar;

	@:native("SDL_SensorGetType")
	static function sensorGetType(sensor:SDLSensor):ConstCharStar;

	@:native("SDL_SensorGetNonPortableType")
	static function sensorGetNonPortableType(sensor:SDLSensor):Int;

	@:native("SDL_SensorGetInstanceID")
	static function sensorGetInstanceID(sensor:SDLSensor):SDLSensorID;

	@:native("SDL_SensorGetData")
	static inline function sensorGetData(sensor:SDLSensor, numValues:Int):Single {
		var data:Single = 0;
	...
	static inline function sensorGetDataWithTimestamp(sensor:SDLSensor, numValues:Int):{data:Single, timestamp:UInt64} {
		var data:Single = 0;
		var timestamp:UInt64 = 0;
	...
	static function sensorClose(sensor:SDLSensor):Void;

	@:native("SDL_SensorUpdate")
	static function sensorUpdate(sensor:SDLSensor):Void;
	...
	@:native("SDL_AddTimer")
	static inline function addTimer(intervalMS:UInt32, callback:SDLTimerCallback,
			param:Any):SDLTimerID {
		return untyped __cpp__("SDL_AddTimer({0}, {1}, (void*){2})", intervalMS, callback, param);
	}

	@:native("SDL_RemoveTimer")
	static inline function removeTimer(timerID:SDLTimerID):Bool {
		return untyped __cpp__("SDL_RemoveTimer({0})", timerID) == Boolean.TRUE;
	}

	// haxe helper functions //
	@:native("SDL_Event")
	static inline function makeEvent():SDLEvent {
		var event:SDLEvent = null;
