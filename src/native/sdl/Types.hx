...
extern class SDLVertex {
	...
	public static inline function create(pos:SDLFPoint, col:SDLColor , tex:SDLFPoint):SDLVertex {
...
extern class SDLColor {
	...
	public static inline function create(r:UInt8, g:UInt8, b:UInt8, a:UInt8): SDLColor {
...
extern class SDLPoint {
	...
	public static inline function create(x:Int, y:Int):SDLPoint  {
...
extern class SDLFPoint {
	...
	public static inline function create(x:Float, y:Float):SDLFPoint{
...
extern class SDLRectangle {
	...
	public static inline function create(x:Int, y:Int, w:Int, h:Int):SDLRectangle {
...
extern class SDLFRectangle {
	...
	public static inline function create(x:Float, y:Float, w:Float, h:Float):SDLFRectangle {
